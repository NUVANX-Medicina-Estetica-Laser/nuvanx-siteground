...
$inline_organization = array(
	'@type' => 'Organization',
	'name'  => 'External diagnostics partner',
);
$inline_graph = array(
	array(
		'@type'           => 'Organization',
		'@id'             => 'https://nuvanx.test/#organization',
		'department'      => $inline_organization,
		'subOrganization' => array(
			$inline_organization,
			array( '@id' => 'https://nuvanx.test/#goya' ),
		),
...
$inline_result = nvx_clinic_identity_schema_graph( $inline_graph );
nvx_clinic_identity_test_assert( $inline_organization === ( $inline_result[0]['department'] ?? array() ), 'INLINE_ASSOC_ORGANIZATION_PRESERVED' );
nvx_clinic_identity_test_assert( $inline_organization === ( $inline_result[0]['subOrganization'][0] ?? array() ), 'INLINE_LIST_ORGANIZATION_PRESERVED' );
nvx_clinic_identity_test_assert( 1 === count( $inline_result[0]['subOrganization'] ?? array() ), 'INLINE_LIST_REMOVES_ONLY_DISALLOWED_CLINIC' );
