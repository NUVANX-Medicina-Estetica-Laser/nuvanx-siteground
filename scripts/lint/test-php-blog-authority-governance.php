...
$fallback_once  = nvx_btl_govern_rendered_content( $without_anchor );
nvx_block6_assert( 1 === substr_count( $fallback_once, 'data-nvx-btl-clinical-note="1"' ), 'BTL_NOTE_FALLBACK_APPENDED' );
$fallback_twice = nvx_btl_govern_rendered_content( $fallback_once );
nvx_block6_assert( 1 === substr_count( $fallback_twice, 'data-nvx-btl-clinical-note="1"' ), 'BTL_NOTE_FALLBACK_IDEMPOTENT' );
