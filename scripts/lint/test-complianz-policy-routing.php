...
$label_only_privacy = nvx_rewrite_complianz_policy_links(
	'<a class="cmplz-link" href="#">Política de privacidad</a>'
);
nvx_assert_contains( 'href="https://nuvanx.com/politica-privacidad/"', $label_only_privacy, 'label_only_privacy' );

$label_only_cookies = nvx_rewrite_complianz_policy_links(
	'<a class="cmplz-link" href="#">Política de cookies</a>'
);
nvx_assert_contains( 'href="https://nuvanx.com/politica-de-cookies-ue/"', $label_only_cookies, 'label_only_cookies' );

$label_only_legal = nvx_rewrite_complianz_policy_links(
	'<a class="cmplz-link" href="#"><span>Aviso legal</span></a>'
);
nvx_assert_contains( 'href="https://nuvanx.com/aviso-legal/"', $label_only_legal, 'label_only_legal' );

$empty_href_privacy = nvx_rewrite_complianz_policy_links(
	'<a class="cmplz-link" href="">Política de privacidad</a>'
);
nvx_assert_contains( 'href="https://nuvanx.com/politica-privacidad/"', $empty_href_privacy, 'empty_href_policy_fallback' );
...
fwrite( STDOUT, "COMPLIANZ_POLICY_ROUTING=PASS cases=20 privacy=canonical cookies=canonical legal=canonical metadata=authoritative label_fallback=canonical js_controls=preserved template_url=preserved owner=single\n" );
