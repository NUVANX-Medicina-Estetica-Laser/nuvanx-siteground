...
assert.doesNotMatch(hubspot, /nvx_hubspot_secure_load_dependencies/,
  'Bootstrap must be the sole loader for the consent owner');
assert.doesNotMatch(hubspot, /require_once[^;]*nvx-marketing-consent\.php/,
...
console.log('PHP_INTEGRATIONS_TRANSPORT=PASS modules=8 consent=server-api-fail-closed loader=bootstrap-only signing=hmac ownership=ordered');
