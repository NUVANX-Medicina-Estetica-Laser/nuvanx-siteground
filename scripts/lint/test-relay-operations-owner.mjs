...
assert.match(queue, /wp_transition_post_status\(\s*\$new_status,\s*\$expected_status,\s*\$post\s*\)/,
  'Direct-SQL status CAS in queue must dispatch transition_post_status to operations listener');
