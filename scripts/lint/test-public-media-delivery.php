...
if ( in_array( 2892, $registry_ids, true ) ) {
	$fail( 'legacy_consultation_still_in_authentic_registry' );
}
if ( ! in_array( 2877, $registry_ids, true ) ) {
	$fail( 'optimized_consultation_missing_from_authentic_registry' );
}
...
echo 'PUBLIC_MEDIA_DELIVERY=PASS cases=9' . PHP_EOL;
