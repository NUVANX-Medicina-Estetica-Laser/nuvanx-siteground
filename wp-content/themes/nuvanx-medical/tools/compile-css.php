 ...
 *
 * This CLI-only compiler is the single owner for generated theme CSS. CI,
 * Staging and Production all execute this same file so the validated artifact
 * graph is the graph that reaches runtime.
 */
...
/** Normalize CSS exactly once before hashing and writing. */
function nvx_css_normalize(string $raw): string
{
    return trim(str_replace(["\r\n", "\r"], "\n", $raw));
}

/** Read a required UTF-8 source file or fail closed. */
...
/** Ten-character SHA-256 content identity used by runtime filenames. */
